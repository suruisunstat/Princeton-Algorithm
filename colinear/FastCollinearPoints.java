 ...
 * Purpose: This program implements the idea in BruteCollinearPoints.java (examines 4 points at a time and checks whether they all lie on 
 * the same line segment, returning all such line segments), but with a faster solution.
 * 
 * 
...
public class FastCollinearPoints {
    ...
    public static void main(String[] args) {
        ...
        //StdOut.println(fcp.segments().length);
    }
